...
/***/ function(module, exports, __webpack_require__) {
	...
	var _top = __webpack_require__(255);
	...
	var _run = __webpack_require__(262);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: '/test', component: TestPage })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mockImage = __webpack_require__(254);
	...
	var image = function image() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? _mockImage2.default : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {

	    case 'CHANGE_PIXEL':
	      var preRows = state.slice(0, action.rowIndex);
	      var postRows = state.slice(action.rowIndex + 1, state.length);
	      var targetRow = state[action.rowIndex];

	      var row = targetRow.slice(0, action.colIndex).concat([action.value], targetRow.slice(action.colIndex + 1, targetRow.length));
	...
	var demoApp = (0, _redux.combineReducers)({
	  image: image
	});
...
/***/ function(module, exports) {
	...
	var sketch = ['  xxxx  ', ' x    x ', 'x x  x x', 'x      x', 'x x  x x', 'x  xx  x', ' x    x ', '  xxxx  '];
	var initialImage = sketch.map(function (line) {
	  return [].concat(_toConsumableArray(line)).map(function (char) {
	    return char === 'x' ? '#FF0000' : '';
	  });
	});

	exports.default = initialImage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _demoPov = __webpack_require__(256);

	var _demoPov2 = _interopRequireDefault(_demoPov);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var TopPage = function TopPage(props) {
	  return _react2.default.createElement(
	    'div',
	    { id: 'top' },
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'p',
	        null,
	        'React component for displaying persistent of vision'
	      ),
	      _react2.default.createElement(
	        'a',
	        { href: 'https://github.com/wikrsh/pov-js' },
	        'View source'
	      )
	    ),
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'vibrater' },
	        _react2.default.createElement(_demoPov2.default, {
	          height: 160 })
	      )
	    ),
	    _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DemoPov = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_lib.Pov);

	exports.default = DemoPov;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PixelEditor = exports.Pov = undefined;

	var _pov = __webpack_require__(258);

	var _pov2 = _interopRequireDefault(_pov);

	var _pixelEditor = __webpack_require__(259);

	var _pixelEditor2 = _interopRequireDefault(_pixelEditor);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// -*- coding: utf-8 -*-

	exports.Pov = _pov2.default;
	exports.PixelEditor = _pixelEditor2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PovPixel = function PovPixel(props) {
	  var maxFrame = props.frames.length;
	  var n = props.frame % (2 * maxFrame);
	  var color = n < maxFrame ? props.frames[n] : '';
	  var style = {
	...
	PovPixel.propTypes = {
	  frames: _react2.default.PropTypes.array.isRequired,
	  frame: _react2.default.PropTypes.number.isRequired
	};

	var Pov = _react2.default.createClass({
	  displayName: 'Pov',
	  ...
	  render: function render() {
	    ...
	    var pixels = this.props.image.map(function (row, index) {
	      return _react2.default.createElement(PovPixel, {
	        key: index,
	        frames: row,
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'pov-container', style: style },
	      pixels
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pixel = function Pixel(props) {
	  ...
	  return _react2.default.createElement('div', { style: style, onClick: props.onClick });
	}; // -*- coding: utf-8 -*-
	...
	var PixelRow = function PixelRow(props) {
	  var pixels = props.row.map(function (pixel, colIndex) {
	    return _react2.default.createElement(Pixel, {
	      key: colIndex,
	      color: pixel,
	      onClick: function onClick() {
	        props.onClick(colIndex);
	      } });
	  });
	  var style = {
	    display: 'flex',
	...
	var PixelMatrix = function PixelMatrix(props) {
	  var rows = props.matrix.map(function (row, rowIndex) {
	    return _react2.default.createElement(PixelRow, {
	      key: rowIndex,
	      row: row,
	      onClick: function onClick(colIndex) {
	...
	var PixelEditor = _react2.default.createClass({
	  displayName: 'PixelEditor',

	  propTypes: {
	    matrix: _react2.default.PropTypes.array.isRequired,
	    pixelColor: _react2.default.PropTypes.string,
	  ...
	  onClickPixel: function onClickPixel(rowIndex, colIndex) {
	    var newValue = this.props.matrix[rowIndex][colIndex] ? '' : this.state.pixelColor;
	    this.props.onChange(rowIndex, colIndex, newValue);
	  },
	  render: function render() {
	    return _react2.default.createElement(PixelMatrix, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    onChange: function onChange(rowIndex, colIndex, value) {
	      dispatch((0, _actions.changePixel)(rowIndex, colIndex, value));
	    }
	  };
	};

	var DemoPixelEditor = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_lib.PixelEditor);
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'p',
	        null,
	        'Edit pixels and Click \'Run\' to start.'
	      )
	    ),
	    _react2.default.createElement(
	      'div',
	      { className: 'editor' },
	      _react2.default.createElement(DemoPixelEditor, {
	        width: 300,
	        height: 300 })
	    ),
	    _react2.default.createElement(
...
/***/ function(module, exports) {
	...
	var changePixel = exports.changePixel = function changePixel(rowIndex, colIndex, value) {
	  return {
	    type: 'CHANGE_PIXEL',
	    rowIndex: rowIndex,
	    colIndex: colIndex,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RunPage = function RunPage(props) {
	  return _react2.default.createElement(
	    'div',
	    { id: 'edit' },
	    _react2.default.createElement(
